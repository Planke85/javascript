...
function findIndex(){
    ...
    if(isNaN(indexToFind)){
        ...
        document.getElementById("searchIndex").innerHTML = `Your index number ${indexToFind} is not in array!`;
        resetInput();
    }
    else {
        document.getElementById("searchIndex").innerHTML = `Your search index number ${indexToFind} has position ${myArray.indexOf(indexToFind)} in your array.`;
        resetInput();
    }
}
